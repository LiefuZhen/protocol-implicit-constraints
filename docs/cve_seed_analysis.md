...
本文件把 T1 调研中的 CVE/advisory 种子展开成可供 T2 继续复核的材料。当前结论统一按 **seed / candidate** 管理。
...
| T2 动作 | 选择一个具体实现和一个具体畸形包类型，形成可控 parser 子任务。 |
...
4. **CoAP Token / COAP-IC-0001**：适合 T7 生成试验。
